 ...
 * $Revision: 236 $
 * 
 * OEG, Change line 1675 : Need to mantain referece reather that 
 * copy of the metada properties of json_data. 
 * Plus, if we have circular reference, the function $.extends fail an 
 * fall in infinty loop or recursion. Not reported side effects caused by the change 
 */
	...
	$.jstree.plugin("json_data", {
		...
		_fn : {
			...
			load_node_json : function (obj, s_call, e_call) {
				//TODO OEG Wee need reference reather a copys
